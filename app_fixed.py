...
def generate_ela(image_path):
    ...
    ela_path = os.path.join(app.config["ELA_FOLDER"], os.path.basename(image_path))
...
def highlight_tampering(ela_path):
    ...
    result_path = ela_path.replace(".png", "_tamper.png").replace(".jpg", "_tamper.jpg")
...
def predict():
    ...
    return render_template("result-apple.html",
        prediction=result,
        img_path=filepath,
        ela_path=ela_path,
